...
CREATE TABLE Endereco (id  integer, bairro varchar(255), cep varchar(255), cidade varchar(255), endereco varchar(255), estado varchar(255), logradouro varchar(255), numero varchar(255), endereco_id bigint, primary key (id));
